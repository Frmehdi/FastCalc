...
app.get('/source',function(req,res){
    ...
    process.getSource(req,xparams,function(status,data,total_data){
       
       var url = '/source?sort_by='+filter_by+'&q='+qsearch+'&page=';
       ...
       //console.log(params);
       res.render('source.ejs',params);
    });
    
});

app.post('/source/save-source',function(req,res){
...
app.post('/source/delete-source',function(req,res){
    
    if(!req.session.username)
	    res.redirect('/login');
    
    process.delete_source(req,function(status,msg){
