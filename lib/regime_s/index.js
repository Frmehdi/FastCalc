...
app.get('/regime_s',function(req,res){
    ...
    process.getCalcule(req,xparams,function(status,data,data1,data2,data3,data4,total_data){
       
       var url = '/regime_s?sort_by='+filter_by+'&q='+qsearch+'&page=';
           
       var params = {
        
            title : 'Liste des notes de calcule',
            data  : data,
            data1 : data1,
            data2 : data2,
            data3 : data3,
       ...
       res.render('regime_s.ejs',params);
    });

});

app.get('/regime_s/exporter',function(req,res){
    ...
    process.getCalcule(req,xparams,function(status,data,data1,data2,data3,data4,total_data){
       ...
       //console.log(params);
       res.render('exporter.ejs',params);
           res.redirect('/regime_s');
    });

});
/*
app.get('/regime_s/report',function(req, res) {
     req.getConnection(function(err,connection){
            query = connection.query('select * from calcule where id_calcule=1;', function(err, rows, fields) {
                if (err) {
                    res.send(err);
                }
                var headers = {};
